...
function loadFromURLParams() {
    ...
    document.getElementById('checkbox1').checked = !(urlParams.get('checkbox1') === 'false');
    document.getElementById('checkbox2').checked = !(urlParams.get('checkbox2') === 'false');
    document.getElementById('checkbox3').checked = !(urlParams.get('checkbox3') === 'false');
    document.getElementById('checkbox4').checked = !(urlParams.get('checkbox4') === 'false');
    document.getElementById('checkbox5').checked = !(urlParams.get('checkbox5') === 'false');
}
